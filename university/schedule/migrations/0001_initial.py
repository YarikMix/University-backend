    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_of_week', models.IntegerField(choices=[(1, 'Понедельник'), (2, 'Вторник'), (3, 'Среда'), (4, 'Четверг'), (5, 'Пятница'), (6, 'Суббота')], default=6, verbose_name='День недели')),
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 10, 27, 22, 27, 9, 217094, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ('date_of_formation', models.DateTimeField(default=datetime.datetime(2023, 10, 27, 22, 27, 9, 217094, tzinfo=datetime.timezone.utc), verbose_name='Дата формирования')),
                ('date_complete', models.DateTimeField(default=datetime.datetime(2023, 10, 27, 22, 27, 9, 217094, tzinfo=datetime.timezone.utc), verbose_name='Дата завершения')),
